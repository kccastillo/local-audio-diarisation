...
**Skill structure examples:** See [references/skill-structures.md](references/skill-structures.md).
...
**YAML frontmatter:** See [references/yaml-frontmatter.md](references/yaml-frontmatter.md).
